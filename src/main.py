...
def main(stdscr, filepath):
    ...
    def action_autocomplete():
        ...
        if completions:
            ...
            stdscr.clear() # Força redesenho completo ao fechar o popup

    def action_help():
        ui.show_help()
        stdscr.clear() # Força redesenho completo ao fechar a ajuda
    ...
    def action_goto_symbol():
        ...
        if symbols:
            ...
            stdscr.clear() # Força redesenho completo ao fechar o seletor
